...
class ContactsQuestionMail extends \core\mail\MailBase
{
...
//		$managers = array('testdeloadm@gmail.com');
		...
		$res = $this->From($this->noreplyEmail)
				->To($managers)
				->Subject('Клиент задал вопрос со страницы Контакты на сайте '.SEND_FROM)
				->Content('data', $this->data)
				->Content('managers', $managers)
				->BodyFromFile('contactsQuestion.tpl')
				->Send();
		if($res)
			return 1;
